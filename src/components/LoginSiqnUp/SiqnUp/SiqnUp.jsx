...
// *********************
//   برای اینه که داده
// رواز اینپوت بگیریم و داخلش ست کنیم
// واصلا ولیو رونشون بده
// e.target.value
// حالت میلادی رونشون بده
// const [birthDate, setBirthDate] = useState("");

// هرچیزی که کاربر وارد کردواونو تبدیل به شمسی کردیم
// تاریخ آماده کردیم داخل اون ست کنیم
// موقعی که میخواهیم سابمیت کنیم
// const [birthDateShamsi, setBirthDateShamsi] = useState("");

// statys
// برای رجیتر 201
// چون یه چیزی ما مسازیم
// ولی برای لاگین
// 200
// یعنی موفقیت امیز هست
